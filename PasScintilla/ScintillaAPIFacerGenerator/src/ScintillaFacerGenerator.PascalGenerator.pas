...
begin
  ...
  else if CppType = 'position' then Result := 'TSciPosition'
  else if CppType = 'line' then Result := 'TSciLine'
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          FImplementations.Add('begin');
          FImplementations.Add('  SendScintillaEditorMessage(SCI_' + UpperCase(Name) + ', ' +
            GenerateWParam(Feature) + ', ' + GenerateLParam(Feature) + ');');
          FImplementations.Add('end;');
        end;
      end;
...
begin
  ...
  try
    ...
    begin
      FProperties.Add('  strict protected');
...
//    Output.Add('  ScintillaDLL = ''Scintilla.dll'';');
//    Output.Add('');
...
//    Output.Add('  FDirectPtr := Pointer(SendScintillaEditorMessage(SCI_GETDIRECTPOINTER, 0, 0));');
//    Output.Add('  FDirectFunction := Pointer(SendScintillaEditorMessage(SCI_GETDIRECTFUNCTION, 0, 0));');
//    Output.Add('end;');
//    Output.Add('');
//
