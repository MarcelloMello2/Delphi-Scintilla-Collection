...
{ TDScintillaCustom }
  ...
  TDScintillaDirectFunction = function(APointer: Pointer; AMessage: Integer; WParam: WPARAM; LParam: LPARAM): LRESULT; cdecl;

  TDScintillaDirectStatusFunction = function(APointer: Pointer; AMessage: Integer; WParam: WPARAM; LParam: LPARAM; var AStatus: Integer): LRESULT; cdecl;
  ...
  private
    ...
    FDirectStatusFunction: TDScintillaDirectStatusFunction;
...
begin
  ...
  FDirectStatusFunction := TDScintillaDirectStatusFunction(Windows.SendMessage(
