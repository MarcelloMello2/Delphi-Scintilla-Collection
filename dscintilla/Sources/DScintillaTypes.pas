...
// <scigen>
  ...
  /// <summary>ELement constants.</summary>
  SC_ELEMENT_LIST = 0;
  ...
  /// <summary>Set the color of a visual element. Value of SC_ALPHA_TRANSPARENT to SC_ALPHA_OPAQUE are allowed.</summary>
  SCI_SETELEMENTCOLOUR = 2753;

  /// <summary>Get the color of a visual element.</summary>
  SCI_GETELEMENTCOLOUR = 2754;

  /// <summary>Use the default color of a visual element.</summary>
  SCI_RESETELEMENTCOLOUR = 2755;

  /// <summary>Returns true when an element color has been set; false indicates the default color is in use.</summary>
  SCI_GETELEMENTISSET = 2756;

  /// <summary>Returns true when the element allows for translucent drawing.</summary>
  SCI_GETELEMENTALLOWSTRANSLUCENT = 2757;

  /// <summary>Returns the default color of a visual element.</summary>
  SCI_GETELEMENTBASECOLOUR = 2758;

  /// <summary>Set the foreground colour of the main and additional selections and whether to use this setting. It is recommended to use the SCI_SETELEMENT* calls.</summary>
  SCI_SETSELFORE = 2067;

  /// <summary>Set the background colour of the main and additional selections and whether to use this setting. It is recommended to use the SCI_SETELEMENT* calls.</summary>
  SCI_SETSELBACK = 2068;

  /// <summary>Get the alpha of the selection.</summary>
  SCI_GETSELALPHA = 2477;

  /// <summary>Set the alpha of the selection. It is recommended to use a combination of setting the layer with SCI_SETSELECTIONLAYER and setting translucency through the SC_ELEMENT_SELECTION_BACK element.</summary>
  ...
  /// <summary>Layer constants.</summary>
  SC_LAYER_BASE = 0;
  ...
  /// <summary>PrintColourMode - use the current screen colours for both foreground and background. This is the only mode that does not set the background colour of the line number margin to white.</summary>
  ...
  /// <summary>Find some text in the document.
  /// Uses 32-bit indexing and is limited to the first 2GB of the document. SCI_FINDTEXTFULL is preferred.</summary>
  SCI_FINDTEXT = 2150;

  /// <summary>On Windows, will draw the document into a display context such as a printer.
  /// Handles 32-bit positions and it not suitable for documents over 2GB. SCI_FORMATRANGEFULL is preferred.</summary>
  ...
  /// Handles 32-bit positions and it not suitable for documents over 2GB. SCI_GETTEXTRANGEFULL is preferred.</summary>
  ...
  /// <summary>Retrieve the value in the target.</summary>
  ...
  /// <summary>Automatic folding behaviour constants.</summary>
  ...
  /// <summary>Returns true if the range is a word or set of words by checking if the start and end are word transitions.</summary>
  ...
  /// <summary>Set the target start to the start of the document and target end to the end of the document.</summary>
  ...
  /// <summary>Use popup options.</summary>
  SC_POPUP_NEVER = 0;
  SC_POPUP_ALL = 1;
  SC_POPUP_TEXT = 2;
  ...
  /// <summary>Create document options.</summary>
  ...
  /// <summary>Indicator value flags.</summary>
  ...
  /// <summary>Set the language lexer of the document.</summary>
  SCI_SETILEXER = 4033;
  ...
  /// <summary>TDSciSCNotification.listCompletionMethod values for SCN_AUTOCSELECTION notifications.</summary>
  SC_AC_FILLUP = 1;
  SC_AC_DOUBLECLICK = 2;
  SC_AC_TAB = 3;
  SC_AC_NEWLINE = 4;
  ...
  /// <summary>TDSciSCNotification.characterSource values for SCN_CHARADDED notifications.</summary>
  ...
  /// <summary>Allocate memory for new lines. This will never reduce the number of lines.</summary>
  ...
  /// <summary>Set the foreground and background colour of a marker number using colouralpha which supports translucency.</summary>
  SCI_MARKERSETFORETRANSLUCENT = 2294;
  SCI_MARKERSETBACKTRANSLUCENT = 2295;

  /// <summary>Set the highlight background colour of a marker number when its folding block is selected. The default colour is #FF0000.</summary>
  SCI_MARKERSETBACKSELECTEDTRANSLUCENT = 2296;

  /// <summary>Sets the stroke width used to draw the marker in hundredths of a pixel. The default value is 100 indicating a single pixel wide line.</summary>
  SCI_MARKERSETSTROKEWIDTH = 2297;

  /// <summary>Reverse order of characters of current line.</summary>
  SCI_LINEREVERSE = 2354;

  /// <summary>Similar to SCI_BRACEMATCH, but matching starts at the explicit start position startPos instead of the implicitly next position pos ± 1.</summary>
  SCI_BRACEMATCHNEXT = 2369;

  /// <summary>Returns the options that were used to create the document.</summary>
  SCI_GETDOCUMENTOPTIONS = 2379;

  /// <summary>Autocompletion multiple selection behavior constants.</summary>
  ...
  /// <summary>Autocompletion options.</summary>
  ...
  /// <summary>Phase drawing constants.</summary>
  SC_PHASES_ONE = 0;
  SC_PHASES_TWO = 1;
  ...
  /// <summary>Clears explicit tabstops on a line. Changing tab stops produces a SC_MOD_CHANGETABSTOPS notification.</summary>
  SCI_CLEARTABSTOPS = 2675;

  /// <summary>Adds an explicit tabstop at the specified distance from the left (in pixels). Changing tab stops produces a SC_MOD_CHANGETABSTOPS notification.</summary>
  SCI_ADDTABSTOP = 2676;

  /// <summary>Gets the next explicit tabstop position set after the given x position, or zero if there aren't any.</summary>
  SCI_GETNEXTTABSTOP = 2677;

  /// <summary>IME interaction constants.</summary>
  SC_IME_WINDOWED = 0;
  SC_IME_INLINE = 1;
  ...
  /// <summary>Set and get the start and end of the target.</summary>
  SCI_SETTARGETRANGE = 2686;

  /// <summary>Adds the next occurrence of the main selection within the target to the set of selections as main. If the current selection is empty then select word around caret.</summary>
  SCI_MULTIPLESELECTADDNEXT = 2688;

  /// <summary>Similar to SCI_MULTIPLESELECTADDNEXT but adds multiple occurrences instead of just one.</summary>
  SCI_MULTIPLESELECTADDEACH = 2689;

  /// <summary>Idle styling constants.</summary>
  ...
  /// <summary>Adds a new vertical edge to the view at the given column number.</summary>
  SCI_MULTIEDGEADDLINE = 2694;

  /// <summary>Clear all vertical edges.</summary>
  SCI_MULTIEDGECLEARALL = 2695;

  /// <summary>Get the column of the Nth vertical edge (indexed from 0).</summary>
  ...
  /// <summary>Toggle folding state of the line and show additional text to the right of folded text when contracted.</summary>
  SCI_TOGGLEFOLDSHOWTEXT = 2700;

  /// <summary>Fold display text style constants.</summary>
  ...
  /// <summary>Returns 1 if regular caret moves will extend or reduce the selection, 0 if not.</summary>
  SCI_GETMOVEEXTENDSSELECTION = 2706;

  /// <summary>Bidirectional text constants.</summary>
  ...
  /// <summary>Line character index constants.</summary>
  SC_LINECHARACTERINDEX_NONE = 0;
  SC_LINECHARACTERINDEX_UTF32 = 1;
  SC_LINECHARACTERINDEX_UTF16 = 2;

  /// <summary>Returns which if any indexes are active.</summary>
  SCI_GETLINECHARACTERINDEX = 2710;

  /// <summary>Allocate or release one or more indexes using same enumeration as SCI_GETLINECHARACTERINDEX.</summary>
  SCI_ALLOCATELINECHARACTERINDEX = 2711;
  SCI_RELEASELINECHARACTERINDEX = 2712;

  /// <summary>Get the document line of a particular character or code unit.</summary>
  SCI_LINEFROMINDEXPOSITION = 2713;

  /// <summary>Finds the starting position of a document line either in characters or code units from the document start.</summary>
  SCI_INDEXPOSITIONFROMLINE = 2714;

  /// <summary>UTF-16 versions of SCI_POSITIONRELATIVE and SCI_COUNTCHARACTERS working in terms of UTF-16 code units.</summary>
  ...
  /// <summary>Get the Nth marker handle or marker number in a given line</summary>
  ...
  /// <summary>Clear all end of line annotations.</summary>
  SCI_EOLANNOTATIONCLEARALL = 2744;

  /// <summary>End of line annotation visibility constants.</summary>
  ...
  /// <summary>Feature constants.</summary>
  ...
  /// <summary>Test is a feature is available, e.g. not all features are available for Direct2D and GDI drawing.</summary>
  ...
  /// <summary>Control char representation appearance.</summary>
  ...
  /// <summary>Clear all representations.</summary>
  SCI_CLEARALLREPRESENTATIONS = 2770;

  /// <summary>Replaces the selected text or empty selection with the given text.</summary>
