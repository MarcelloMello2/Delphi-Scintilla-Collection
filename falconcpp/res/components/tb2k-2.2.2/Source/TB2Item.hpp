...
// (DO NOT EDIT: machine generated header) 'Tb2item.pas' rev: 21.00
...
typedef void __fastcall (__closure *TTBAdjustImageIndexEvent)(TTBCustomItem* Sender, Imglist::TImageIndex &AImageIndex);
...
#pragma option push -b-
enum TTBOrientation { tboHorizontal, tboVertical };
#pragma option pop
...
private:
	...
	Menus::TPopupMenu* FSubitemsPopupMenu;
	...
	void __fastcall InternalSetPopupMenu(Menus::TPopupMenu* &Menu, Menus::TPopupMenu* NewMenu);
	...
	void __fastcall SetSubitemsPopupMenu(Menus::TPopupMenu* Value);
...
public:
	...
	__property Menus::TPopupMenu* SubitemsPopupMenu = {read=FSubitemsPopupMenu, write=SetSubitemsPopupMenu};
...
public:
	...
	Types::TPoint __fastcall UpdatePositions(void);
...
protected:
	...
	DYNAMIC Types::TPoint __fastcall GetNCSize(void);
