...
}
{
  Author: hdalis (hdalis@users.sourceforge.net)
     $Id: SciResLang.pas,v 1.1 2004/12/03 17:18:59 hdalis Exp $
...
//SciPropertyMgr
sPropBaseSettings='Base Settings';
sPropExtension='Extension';
sPropSectionStart='START';
sPropSectionEnd='END';
sPropAssignments='assignments';

sInstructionHeader1='# Property format: CategoryName[:partname]/Language.PropertyName[.StyleNumber/KeylistNumber/OtherNumber]=Value';
sInstructionHeader2='# The part in [] are optional';
...
// SciLexer
sSciLexerNotFound='"SciLexer.DLL" are not available.  '#13#10+'Please make sure is located on the System Path';
